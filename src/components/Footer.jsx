...
function Footer() {
  return (
    <div className="flex gap-1 w-full h-screen bg-zinc-900 p-20 font-['FoundersGroteskX-Condensed-Regular']">
        <div className='w-1/2 h-full flex flex-col justify-between'>
        <div className='heading'>
        <h1 className='text-[8vw] font-xl uppercase leading-none -mb-10'>Eye-</h1>
        <h1 className='text-[8vw] font-xl uppercase leading-none -mb-10'>Opening</h1>
      ...
      <div className='w-1/2'>
      <h1 className='text-[6vw] font-xl uppercase leading-none -mb-10'>Presentations</h1>
      <div className='details font-["Neue_Montreal"] mt-40'>
        ...
        <a className='block text-xl font-light' href='#'>You Tube</a>
